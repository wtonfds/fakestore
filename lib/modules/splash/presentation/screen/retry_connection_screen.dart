...
import 'package:vest_store/modules/utils/app_colors.dart';
import 'package:vest_store/modules/utils/wave_widget.dart';
        ...
        children: <Widget>[
          Container(
            ...
            child: Column(
              children: [
                Center(
                    child: Image.asset('assets/images/vesti.png',
                        width: 310, height: 85)),
              ],
            ),
          ),
